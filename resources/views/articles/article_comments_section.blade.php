...
<div class="container comments-section">
    @if (!Auth::guest())
        <div class="row comment-row">
            <div class="col-lg-2">
                <div class="rounded-circle comment-user-photo" style="background-image: url({{Auth::user()->profile->profileImage()}});"></div>
            </div>
    ...
    @if (count($comments) > 0)
        @foreach ($comments as $comment)
            <div class="row comments-row">
                <div class="col-lg-2">
                    <div class="rounded-circle comment-user-photo" style="background-image: url({{$comment->user->profile->profileImage()}});"></div>
